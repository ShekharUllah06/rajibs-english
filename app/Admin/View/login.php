...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="/rajibs-english/assets/admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="admin/login"><b>Framework </b>Authorization</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
